...
class Profile(models.Model):
    ...
    user = models.OneToOneField(User, on_delete=models.CASCADE) # CASCADE user silindiğinde usera ayit profile ı siler
    def __str__(self) :
...
class Adress(models.Model):
    ...
    # birden fazla user adına kayıt yapılabilinir 
...
class Product(models.Model):
    ...
    user = models.ManyToManyField(User) # bir ürün birden fazla useraaa kayıt olabilir 
