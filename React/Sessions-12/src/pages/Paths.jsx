    ...
    <div className="container mt-4">
      ...
      <div>
        <Link className="btn btn-success w-50" to="">
          {/* to içi boş olmasının sebebi path sayfasına geri dönerek defaul olan fullstack i göstermek "/pathe" olabilir ama "path" olamaz çünkü path/path olarak yönlendirir hata almasına neden olur */}
