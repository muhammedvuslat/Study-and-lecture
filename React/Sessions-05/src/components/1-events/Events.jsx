...
const Events = () => {
  let message = "Event Based Programing";
  const handleClick = () => {
  ...
  const handleChange = (event) => {
    console.log(event.target); //! Parametre il konsol log da tuşa basıldığında hedefi kodu görebiliriz
    message = "React";
    console.log(message);
  };
  return (
    <div className="container text-center mt-4">
      ...
      <button
        onClick={() => handleClear("Clear button cliked")}
